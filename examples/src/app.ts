...
import { ChartComponent, StockChartComponent, ChartSeriesComponent, ChartEventWrapper, ChartPointComponent } from '../../index';
...
@Component({
    selector: 'app',
    directives: [ChartComponent, StockChartComponent, ChartSeriesComponent, ChartPointComponent],
    template: `
        ...
        <div>
            <chart [options]="options"
                ...
                <series (click)="onSeriesClick($event)"
                        ...
                        <point (select)="onPointSelect($event)" (click)="onPointClick($event)">
                        </point>
                </series>
            </chart>
        </div>
